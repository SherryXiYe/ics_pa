...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),         /* push的opcode为0x50-0x57 */
  /* 0x54 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),
  /* 0x58 */	IDEX(r,pop), IDEX(r,pop), IDEX(r,pop), IDEX(r,pop),             /* pop的opcode为0x58-0x5b、0x5d-0x5f */
  ...
  /* 0xe8 */	IDEX(J,call), IDEX(J,jmp), EMPTY, IDEXW(J,jmp,1),                /* call的opcode为0xE8 */
  ...
  /* 0x20 */	IDEX(E2G, mov_cr2r), EMPTY, IDEX(E2G, mov_r2cr), EMPTY,
  ...
  /* 0xa4 */	IDEX(I_G2E, shld), IDEX(I_G2E, shld), EMPTY, EMPTY,
  /* 0xa8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xac */	IDEX(I_G2E, shrd), IDEX(I_G2E, shrd), EMPTY, IDEX(E2G,imul2),
